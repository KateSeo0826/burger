                    ...
                    <div style="padding: 2rem 1rem;">
                        ...
                        <div style="text-align:center;">
                            <button style="background-color: #262626; outline: none; width: 180px; height: 40px; border-radius: 20px; text-align: center; font-size: 1rem; margin-top:2rem;">
                                <a style="text-decoration: none; color: #ffffff;" href="/burger">Confirm</a>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 600px; max-width: 100%; background-color:#74baff; border: 1px solid #CCC; padding: 50px; border-radius: 10px;">
                            <tbody>                            
                                ...
                                <tr> <td align="center" valign="middle" style="color: #262626; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 20px; font-weight: bold;">The Bite Burger Team.</td> </tr>                            
                                <tr> <td>&nbsp;</td> </tr>
                                <tr> <td>&nbsp;</td> </tr>
                                <tr> <td align="center" valign="middle" style="color: #262626; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">If you need help or have any questions, please visit <a href="https://kateseo0826.github.io/burger" style="color:#0094aa;">https://kateseo0826.github.io/burger</a><br /> Or you can reach it at '.$site_phone.'.</td> </tr>                            
                            </tbody>
                        </table>
                        </td>
                    </tr>
...
function sendMail($subject, $messageBody, $altBody, $addAddress, $responseMessage = Null) {
    ...
    try {
        ...
        $mail->Password = "pvkgyutkltxcheyw";
